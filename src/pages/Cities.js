...
const Cities = () => {
    ...
    const changeHandle = (e) => {
        setFilteredCities(cities.filter(city => city.name.toLocaleLowerCase().substring(0, e.target.value.length).includes(e.target.value)))
        setPagination(0);
    }
    ...
    return (
        <>
            ...
            <div className=' flex  justify-center flex-col  items-center h-screen'>
                ...
                <div className='xl:w-3/4 flex flex-col items-center flex-1 py-6 lg:py-0  '>
                    <input
                    ...
                    <div className='w-full  flex lg:flex-row flex-col  justify-center lg:justify-between items-center flex-1  relative  px-2 bg-red-0 py-4 lg:py-0'>
